...
export class OrdersUpdateCreatedAt1733677257797 implements MigrationInterface {
    name = 'OrdersUpdateCreatedAt1733677257797'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`created_at\` \`created_at\` timestamp(0) NULL`);
